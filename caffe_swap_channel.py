...
net_file = '/home/liuhao/Projects/Projects/MXNet2Caffe/cartoon_0709.prototxt'
...
net_caffe.params['conv0_fwd'][0].data[...]=net_caffe.params['conv0_fwd'][0].data[...][:,::-1,:,:]
# with open("/home/liuhao/CLionProjects/FeatureExtractor/model/keypoint_rgb.prototxt",'w') as f:
#     f.write(str(net_caffe.to_proto()))

net_caffe.save("/home/liuhao/Projects/Projects/MXNet2Caffe/onet_cls_liuhua_bgr.caffemodel")
os.system("cp %s %s"%(net_file,"/home/liuhao/Projects/Projects/MXNet2Caffe/onet_cls_liuhua_bgr.prototxt"))
